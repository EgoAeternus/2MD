...
if os.path.exists('config.ini'):
    ...
    source_folder = input("Source folder (where .txt files are located): ")
    destination_folder = input("Destination folder (where .md files will be moved): ")
